...
import DoctorAndPpacient from '../../assets/DoctorAndPpacient.png'
import MapPin from '../../assets/map-pin.png'
import Mail from '../../assets/mail.png'
import PicContact from '../../assets/PicContact.png'
...
function BodyPage() {
    ...
    ScrollReveal({
        ...
        distance: '30px',
        duration: 900,
    }).reveal('.information, .card, h2, p, img, h4, button ');
        ...
        <div id="body" className='' >
            <nav id='navigation' >
                ...
                <div className='wrapper'>
                    <a onClick={closeMenu} className='logo' href='#home'>
                    ...
                    <div className='menu'>
                        <ul>
                            ...
                            <li><a href='#services-ancora' onClick={closeMenu}>Seviços</a></li>
                            <li><a href='#about-ancora' onClick={closeMenu}>Sobre</a></li>
                        </ul>
            ...
            <header id='home' className='wrapper' >
                ...
                <div className='content'>
                    ...
                    <div className='content-about'>
                        <p>Amet minim mollit non deserunt ullamco est sit aliqua 
                            ...
                            dolor do amet sint. Velit officia consequat duis enim.
                            Amet minim mollit non deserunt ullamco est sit aliqua 
                            do amet sint. Velit officia consequat duis enim. Amet
                    ...
                    <div>
                      <img className='efeitoImgAbout' src={DoctorAndPpacient} alt='DoctorAndPpacient' />
                    </div>
            ...
            <section id='contact'>
                <div className='content'>
                    <div className='header'>
                        ...
                        <img className='img' src={PicContact} alt='PicContact' />
